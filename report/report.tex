...
% Gara: propongo unificar el capítulo 1 y 2
%\input{2-antecedentes-objetivos.tex}

% Gara: propongo dividir el capítulo en tres:
% (Se puede justificar referenciando a los pasos de la Figura 1.2)
% Definición de las instancias
% Simulación 
% Optimización
\input{3-desarrollo.tex}

\input{4-resultados.tex}

\input{5-conclusiones-trabajo-futuro.tex}

\input{6-conclusions-future-work.tex}
